...
% ***********************************************
function h=export_data_Callback(gui_object, h)
    ...
    fields={'calibration_flag','xleft','xright','ylim','log_flag',...
            'spectra_threshold','hold_frame','null_flame','yraw','yfit','ytmp'};
    data.fdat=rmfield(data.fdat,fields);
    data.fdat.fit=rmfield(data.fdat.fit,{'display','xleft','xright'});
    
    % Strip Tdat
    fields={'log_flag_left_flag','log_flag_right_flag',...
           'noncont_flag','emissivity_flag',...
           'emissivity_nonc_flag','cont_flag',...
           'xlim','ylim','ylim_eps'};
       
    data.tdat=rmfield(data.tdat,fields);
